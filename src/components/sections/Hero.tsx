...
export const Hero = () => {
  return (
    <section className="w-full flex justify-center py-10 md:py-0 px-4">
      <motion.div
      ...
      >
        ...
        <div className="px-6 md:pl-[52px] pt-10 md:pt-[134px] pb-10 md:pb-0 flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="w-fit h-[32px] px-4 rounded-full bg-[#1E6D00]/10 flex items-center justify-center gap-1.5 mb-8 md:mb-[48px]">
            ...
            <span className="text-[#1E6D00] text-[11px] font-bold tracking-tight uppercase">Version 1.0.0 out now</span>
          </div>

          {/* Heading */}
          <h1 className="text-[32px] md:text-[48px] font-bold text-[#0F172A] leading-[1.1] mb-6 md:mb-[35px] tracking-[-0.02em]">
            LF Launcher – <br className="hidden md:block" />
            Driven by Players.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <button className="h-[52px] w-full sm:w-auto px-8 rounded-lg bg-[#1E6D00] text-white text-[15px] font-bold flex items-center justify-center gap-2 hover:bg-[#1a5c00] transition-all active:scale-95">
              <Download className="w-[18px] h-[18px] stroke-[2.5px]" /> Download
            </button>
            <button className="h-[52px] w-full sm:w-auto px-6 rounded-lg text-[#545F73] text-[15px] font-bold flex items-center justify-center gap-2 hover:bg-black/5 transition-all active:scale-95">
              <FileText className="w-[18px] h-[18px]" /> Changelog
            </button>
          </div>
        </div>
